            ...
            <form action={updateHostSettings} className="space-y-3">
              ...
              <div className="rounded-md border border-zinc-100 bg-zinc-50 px-3 py-2 text-sm">
                ...
                <p className="text-zinc-600">
                  Enabled: {settings.sheets_export_enabled ? "yes" : "no"} · Status:{" "}
                  {settings.sheets_status ?? "disabled"}
                  {settings.sheets_spreadsheet_id ? (
                    <>
                      {" "}
                      ·{" "}
                      <a
                        href={`https://docs.google.com/spreadsheets/d/${settings.sheets_spreadsheet_id}`}
                        target="_blank"
                        rel="noreferrer"
                ...
                <p className="mt-1 text-xs text-zinc-500">
                  Hosts enable this via OAuth in their Settings (no service account).
                </p>
              </div>
              <select
